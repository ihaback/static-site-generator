...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_split_links(self):
        ...
        self.assertListEqual(
            [
                ...
                TextNode(" and ", text_type_text),
                TextNode("another link", text_type_link, "https://blog.google.com"),
    ...
    def test_text_to_textnodes(self):
        nodes = text_to_textnodes(
            "This is **text** with an *italic* word and a `code block` and an ![image](https://i.imgur.com/zjjcJKZ.png) and a [link](https://google.com)"
        )
        self.assertListEqual(
            [
